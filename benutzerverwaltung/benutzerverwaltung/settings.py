...
AUTHENTICATION_BACKENDS = (
    ...
    'benutzeraccounts.backends.EmailBackend'
)
...
AUTH_PASSWORD_VALIDATORS = [
    {
        'NAME': 'django.contrib.auth.password_validation.UserAttributeSimilarityValidator',  #ueberprueft die Aehnlichkeit zwischen dem Passwort und den Attributen des Benutzers
    },
    {
